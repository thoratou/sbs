 ...
 *
 */
public class MandatoryVersion implements Mandatory{
	private String version;
	
	/**
	 * 
	 */
	public MandatoryVersion() {
		version = null;
	}
	...
	public int perform(Parameters pars, int it) {
		version = pars.getParameterAt(it);
		return it;
	}
	...
	public void usage(List<String> manUsage) {
		manUsage.add("<component-version> : the component version");
	}
